...
public class SoundManager : Singleton<SoundManager>
{
    ...
    private float lastBlockMoveTime = -1f;
    private const float BLOCKMOVE_COOLDOWN = 0.2f;
    ...
    public void Play(string name)
    {
        if (name == "blockmove")
        {
            if (Time.time - lastBlockMoveTime < BLOCKMOVE_COOLDOWN)
            {
                return;
            }
    ...
    public IEnumerator TextClear()
    {
        ...
        theTextor.GetComponent<TMP_Text>().text = "";
    }
}